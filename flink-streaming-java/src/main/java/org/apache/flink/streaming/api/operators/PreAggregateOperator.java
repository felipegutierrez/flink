...
@Internal
public class PreAggregateOperator<K, IN, OUT>
	...
	public PreAggregateOperator(ProcessFunction<IN, OUT> function) {
		super(function);
	...
	private class ContextImpl extends ProcessFunction<IN, OUT>.Context {
		...
		// public K getCurrentKey() { return this.getCurrentKey(); }
	}
	...
	private class OnTimerContextImpl extends ProcessFunction<IN, OUT>.OnTimerContext {
		...
		// @Override
		// public K getCurrentKey() { return timer.getKey(); }
	}
}
