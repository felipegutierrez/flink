...
public class TPCHQuery01PreAggregate {
	public static void main(String[] args) throws Exception {
		...
		DataStream<Tuple2<String, Tuple11<String, String, Long, Double, Double, Double, Double, Long, Double, Double, Long>>> lineItemsCombined = lineItemsMap
			.combiner(lineItemPreAggUDF, preAggregationWindowCount, enableController, preAggregateStrategy).disableChaining().name(OPERATOR_PRE_AGGREGATE).uid(OPERATOR_PRE_AGGREGATE).slotSharingGroup(slotGroup01);
