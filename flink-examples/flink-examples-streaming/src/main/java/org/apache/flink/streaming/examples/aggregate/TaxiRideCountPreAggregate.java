...
public class TaxiRideCountPreAggregate {
	...
	public static void main(String[] args) throws Exception {
		...
		PreAggregateFunction<Long, Long, Tuple2<Long, Long>, Tuple2<Long, Long>> taxiRidePreAggregateFunction = new TaxiRidePreAggregateFunction();
	...
	// *************************************************************************
	private static class TaxiRidePreAggregateFunction
